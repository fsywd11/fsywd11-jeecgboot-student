...
<script lang="ts" name="eduselectcourse-eduCourseSelection" setup>
  import {ref, reactive, computed, unref} from 'vue';
  import {BasicTable, useTable, TableAction} from '/@/components/Table';
  import {useModal} from '/@/components/Modal';
  import { useListPage } from '/@/hooks/system/useListPage'
  import EduCourseSelectionModal from './components/EduCourseSelectionModal.vue'
  import {columns, searchFormSchema, superQuerySchema} from './EduCourseSelection.data';
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './EduCourseSelection.api';
       ...
       return [
         {
           ...
           auth: 'eduselectcourse:edu_course_selection:edit'
         }
       ]
   }
     /**
       ...
       return [
         {
           ...
           auth: 'eduselectcourse:edu_course_selection:delete'
         }
       ]
   }

   ...
   <BasicTable @register="registerTable" :rowSelection="rowSelection">
     <!--插槽:table标题-->
      <template #tableTitle>
          ...
          <a-button  type="primary" v-auth="'newLostAndFound:lost_and_found:exportXls'" preIcon="ant-design:export-outlined" @click="onExportXls"> 导出</a-button>
          <j-upload-button type="primary" v-auth="'newLostAndFound:lost_and_found:importExcel'" preIcon="ant-design:import-outlined" @click="onImportXls">导入</j-upload-button>
          ...
          <a-dropdown v-if="selectedRowKeys.length > 0">
              ...
              <a-button v-auth="'newLostAndFound:lost_and_found:deleteBatch'">批量操作
...
<script lang="ts" name="newLostAndFound-lostAndFound" setup>
  ...
  import {list, deleteOne, batchDelete, getImportUrl,getExportUrl} from './LostAndFound.api';
